...
;;;;; isearch
   ...
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-1
                      ...
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background "#0000FF"))
             (t :inverse-video t)))
...
;;;;; font lock
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground "#6B6B6B"))))
   `(font-lock-constant-face ((t (:foreground "#BFEBBF"))))
   `(font-lock-doc-face ((t (:foreground "#FFC600"))))
   `(font-lock-function-name-face ((t (:foreground "#FFFF00" :weight bold))))
   `(font-lock-keyword-face ((t (:foreground "#80FFFF"))))
   ;; TODO -------------------------------------------------------------------->
   ...
   ;; <-------------------------------------------------------------------------
   `(font-lock-string-face ((t (:foreground "#FFC600"))))
   `(font-lock-type-face ((t (:foreground "#FF7575"))))
   `(font-lock-variable-name-face ((t (:foreground "#FFFF00" :weight bold))))
...
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background "#2A2A2A"))
                   (t :weight bold)))
   `(hl-line ((,class (:background "#2A2A2A")) ;; old emacsen,
              (t :weight bold)))
;;;;; hl-sexp
...
;;;;; linum-mode
   `(linum ((t (:foreground "#A8A8A8" :background "#2F2F2F"))))
;;;;; macrostep
   `(macrostep-gensym-1
...
;;;;; whereis
   `(whereis-highlight-face ((t (:background "#FF66CC" :foreground "#FFFFFF" :weight bold :height 1.3))))
   `(whereis-number-face ((t (:foreground "FF66CC"))))
   `(whereis-filepath-face ((t (:foreground "#93E0E3" :underline t))))
   `(whereis-hl-line-face ((t (:background "#3B3B3B" :weight bold :slant italic))))
   `(whereis-odd-candidate-face ((t (:background "#1C1C1C"))))
   `(whereis-even-candidate-face ((t (:background "#1C1C1C"))))
   ))
